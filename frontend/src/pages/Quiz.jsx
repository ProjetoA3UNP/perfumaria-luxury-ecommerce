...
const PERGUNTAS = [
  ...
  },
  {
    ...
    peso: 5,
    opcoes: [
      { label: "🌲 Amadeirado Escuro", valor: "Amadeirado Escuro" },
      { label: "🌊 Aquático / Fresco", valor: "Aquático" },
      { label: "🌸 Floral Branco", valor: "Floral Branco" },
      { label: "🍊 Cítrico Aromático", valor: "Cítrico Aromático" },
      { label: "🧁 Gourmand / Doce", valor: "Gourmand" },
      { label: "🔥 Oriental Especiado", valor: "Oriental Especiado,Couro" },
      { label: "🌿 Fougère / Herbal", valor: "Fougère,Herbal/Verde" },
      { label: "🍂 Chipre / Clássico", valor: "Chipre" },
    ],
  },
  {
    ...
    opcoes: [
      ...
      { label: "✨ Designer", valor: "Designer" },
      { label: "🌟 Celebrity", valor: "Celebrity" },
      { label: "🏃 Casual / Esportivo", valor: "Casual,Esportivo" },
      { label: "🌱 Natural / Orgânico", valor: "Natural/Orgânico" },
      { label: "🎨 Indie / Artesanal", valor: "Indie" },
      { label: "🕰️ Vintage / Exótico", valor: "Vintage,Exótico" },
    ],
  },
  {
